...
```{r}
#
Q1D<- select(PlacementData,HSE_Grade,UG_Grade, MBA_Grade, JobStatus) %>% group_by(JobStatus) 
...
```{r}
#
Q2D<- select(PlacementData,HSE_Grade,UG_Grade, MBA_Grade, Salary) %>% group_by(Salary)
